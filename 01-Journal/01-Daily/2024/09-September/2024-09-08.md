...
>[!multi-column]
> >[!Over Due]+ Due before 2024-09-08
>> ```tasks
>> not done
...
>> ```
> 
>>[!Due Today|purple]+ Due 2024-09-08
>> ```tasks
>> not done
>> due on 2024-09-08
>> hide tags
...
> WHERE journal-start-date = date(2024-09-08) - dur(12 months) OR
> journal-start-date = date(2024-09-08) - dur(24 months) OR
> journal-start-date =  date(2024-09-08) - dur(36 months) OR
> journal-start-date =  date(2024-09-08) - dur(48 months)
> SORT journal-start-date DESC
> ```

> [!warning]+ Files Created (2024-09-08)
>  ```dataview
>  table without id
>  file.link as Note,
...
> [!summary]+  Files Modified (2024-09-08)
>  ```dataview
> table without id
> file.link as Note,
> file.folder as Folder,
