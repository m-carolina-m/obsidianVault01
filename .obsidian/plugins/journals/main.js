...
class CreateJournalModal extends obsidian.Modal {
    ...
    display() {
        ...
        if (this.type === "interval") {
            ...
            new obsidian.Setting(contentEl).setName("Start date").addButton((button) => {
...
const FRONTMATTER_ADDING_DELAY = 800;
    ...
    ensureDateNote(startDate, endDate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!file) {
                ...
                file = yield this.app.vault.create(filePath, yield this.getContent(this.getTemplateContext(startDate, endDate, this.getNoteName(startDate, endDate))));
                if (!(file instanceof obsidian.TFile))
                    throw new Error("File is not a TFile");
                yield delay(FRONTMATTER_ADDING_DELAY);
...
class IntervalJournal {
    ...
    open(date) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.openInterval(this.findInterval(date));
        });
    }
    openNext(date) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.openInterval(this.intervals.findNextInterval(date));
        });
    }
    openPrev(date) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.openInterval(this.intervals.findPreviousInterval(date));
        });
    }
    autoCreateNotes() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.config.createOnStartup)
                return;
            yield this.ensureIntervalNote(this.findInterval());
        });
    }
    openStartupNote() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    ensureIntervalNote(interval) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!file) {
                yield ensureFolderExists(this.app, filePath);
                file = yield this.app.vault.create(filePath, yield this.getContent(this.getTemplateContext(interval, this.getNoteName(interval))));
                if (!(file instanceof obsidian.TFile))
                    throw new Error("File is not a TFile");
                yield delay(FRONTMATTER_ADDING_DELAY);
...
class SettingsIntervalPage extends SettingsWidget {
    constructor(app, containerEl, config, calendar) {
        super(app);
        this.containerEl = containerEl;
        this.config = config;
        this.calendar = calendar;
